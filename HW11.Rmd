...
* After looking at the results it appears that there is not a significant relationship for elevation and temperature (pVal > 0.05) and the same result for elevation and mean annual precipitation (PVal > 0.05). My next step would be to preform a PCA to test the covariances / correlations between all the bioclim variables from the original data set to see which is producing the most variation. The results of the PCA analysis would help me to continue to piece apart which environmental variables are most influential to understading the biogeography and distribution of this interesting variety of Athyrium filix femina. 